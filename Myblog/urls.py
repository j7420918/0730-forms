...
urlpatterns = [
    ...
    path('sampleapp/upload/',sampleapp.views.upload,name="upload"),
    path('sampleapp/upload_create/',sampleapp.views.upload_create,name="upload_create"),
    path('sampleapp/profile/',sampleapp.views.profile,name="profile"),
]
